...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    private ResponseEntity<Object> handleInvalidFormatException(InvalidFormatException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        String detail = String.format("A propriedade '%s' recebeu o valor '%s',"
                + "que é de um tipo inváido. Corrija e informe um valor compatível com o tipo %s.", path, ex.getValue(), ex.getTargetType().getSimpleName());
    ...
    private ResponseEntity<Object> handleValidationInternal(Exception ex, BindingResult bindingResult,  HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        String detail = ("Um ou mais campos estão inváldos. Faça o preenchimento correto e tente novamente.");
